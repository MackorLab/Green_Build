  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/avp_grup_v1.js', () => {
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/avp_form.js', () => {
          console.log('Custom script loaded!');
        });
      },
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/avp_koleso_v1.js', () => {
          console.log('Custom script loaded!');
        });
      },
...
editor.Blocks.add('avp_kol-settings-block-block', {
  label: `
    <div style="display: flex; align-items: center;">
      <!-- icon666.com - MILLIONS vector ICONS FREE --><svg id="Layer_1" enable-background="new 0 0 152 152" viewBox="0 0 152 152" xmlns="http://www.w3.org/2000/svg" width="36" height="36"><path id="Icon" clip-rule="evenodd" d="m74.5 112.8h7.8c1.3-.2 2.6-.8 3.6-1.6.6-1 1.1-2.1 1.1-3.4 0 0-.2-10.4 4.7-12s10.9 10.1 17.4 14.6c4.9 3.4 8.6 2.6 8.6 2.6l17.4-.3s9.1-.5 4.7-7.6c-.3-.6-2.6-5.2-13-14.9-10.9-10.1-9.4-8.4 3.7-26 8-10.6 11.2-17.1 10.2-20s-6.8-1.9-6.8-1.9l-19.5.2c-.8-.2-1.8 0-2.6.5s-1.3 1.3-1.8 2.1c-1.9 5.2-4.4 10.4-7.1 15.3-8.8 14.8-12.2 15.6-13.6 14.6-3.2-2.1-2.4-8.6-2.4-13.2 0-14.3 2.1-20.3-4.2-21.8-2.9-.6-6-1-9.1-1-7 0-12.8 0-16.2 1.6-2.4 1-4 3.4-3 3.4 2.3.2 4.2 1.3 5.8 2.9 1.9 2.8 1.9 8.8 1.9 8.8s1.1 16.9-2.8 19c-2.6 1.5-6.2-1.5-14-14.9-2.6-4.7-5-9.4-7-14.5-.3-.8-1-1.6-1.6-2.1-.3-.2-.6-.5-1-.5-1-.5-2.1-.6-3.2-.6l-17.4.2s-2.8 0-3.7 1.3c-1 1.3 0 3.2 0 3.2s14.6 34.1 31 51.2c15.1 15.9 32.1 14.8 32.1 14.8z" fill-rule="evenodd" fill="#000000" style="fill: rgb(255, 255, 255);"></path></svg>
      <span style="margin-left: 10px;">avp_kol</span>
    </div>`,
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/avp_kol_vk_sav.js', () => {
          console.log('Custom script loaded!');
        });
      },
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/avp_site_grup.js', () => {
          console.log('Custom script loaded!');
        });
      },
      // Свойства, которые будут передаваться в скрипт
    ...
    defaults: {
      ...
      script: function(props) {
        ...
        if (typeof $ === 'undefined') {
          ...
          // Загружаем необходимый скрипт динамически
          loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/menu_vk.js', () => {
            console.log('Custom script loaded!');
            initBlock();
          });
        }
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/apps_look_v1.js', () => {
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/menu_look_v1.js', () => {
          initBlock();
          console.log('Кастомные скрипты загружены');
        });
      },
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/senler_btn_ud_v1.js', () => {
          initBlock();
          console.log('Custom script loaded!');
        });
      },
  ...
  model: {
    defaults: {
      ...
      script: function(props) {
        ...
        loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/senler_form_v1.js', () => {
          initBlock();
          console.log('Custom script loaded!');
        });
      },
    ...
    defaults: {
      ...
      script: function(props) {
        ...
        if (typeof anti_copy === 'undefined') {
          loadScript('https://cdn.jsdelivr.net/gh/MackorLab/Green_Build@main/js%20/anti_copy.js', () => {
